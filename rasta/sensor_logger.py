...
class SensorLogger:
    ...
    def __init__(
        ...
        # Add file extension to sensor filename
    ...
    def read_from_zip(self):
        ...
        if not len(self.read_sensors) == 0:
            ...
            # It can be possible that users have provided wrong sensor names, therefore explictly print that
        ...
        for filelist in __readable_files:
            ...
            # Few columns in different sensor has an identical name, so rename
    ...
    def get_data_from_zip(self):
        ...
        TODO: Add support to all available sensors.
    ...
    def save_to_kepler(self, MAPBOX_API_KEY: str, output_map: str = None):
        ...
        self.location["Timestamp"] = self.location["Timestamp"].apply(str)
    ...
    def sync_sensors(
        ...
        """
        Given, 2 dataframes, this module can sync them within a given tol
        interval.
