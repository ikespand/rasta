...
def extract_itinerary(response_json):
    vis = Visualize(
        api_key=MAPBOX_API_KEY, config_file="keplergl_config.json", output_map="OTP-0"
    )
    gdf = []
...
#%%
response_json = navigate_me(
    start_coord="48.701248, 9.037058", end_coord="48.780816, 9.201172"
)
